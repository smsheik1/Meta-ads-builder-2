...
- For semantic extraction in this repo, use the project `.env` variable `NVIDIA_NIM_API_KEY` with the Graphify provider `nvidia-nim` (`https://integrate.api.nvidia.com/v1`).
