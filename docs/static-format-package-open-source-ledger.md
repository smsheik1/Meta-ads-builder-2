...
| Semantic reference analysis | [Gemma 4 31B IT](https://build.nvidia.com/google/gemma-4-31b-it) | Provisional semantic lead; [minimal smoke](./research-intake/minimal-maker-analysis-nim-2026-07-11.md) and [three-ad regression](./research-intake/minimal-maker-analysis-regression-3-2026-07-11.md) complete | Codecademy completed in 59.979s; three known ads completed in 25.100–104.604s; formula and repeated structures were strong, including LinkedIn's four rows and Dumb vs Smart's 3+3 Lists | Regression validity was 2/3 and full semantic acceptance 0/3; build Maker correction for partial drafts, keep invalid cross-references fail-visible, and use only the six-key MVP contract |
...
Gemma 4 31B IT is the provisional semantic lead, not the production selection. The six-key contract removed the timeout class: Codecademy plus three known regressions completed in 25.100–104.604 seconds. Known-ad regression validity was 2/3 and full semantic acceptance 0/3, so stop prompt tuning and build Maker correction around partial drafts; invalid references still fail visibly. The assistant's next naturally saved ad provides real-world validation. Keep Gemma 26B as benchmark evidence, never as a silent fallback.
