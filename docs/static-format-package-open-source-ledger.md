...
| Brand and product extraction | Existing Wiggly research pipeline | Keep | Website brief, Shopify/WooCommerce products, brand assets, fonts, colors | Format-required question resolver and selected-product confirmation |
