...
| --- | --- | --- | --- | --- |
| Graphic-design decomposition | [LayerD](https://github.com/CyberAgentAILab/LayerD) | Primary benchmark candidate; [Graphify assessment complete](./research-intake/layerd-graphify-compatibility-2026-07-10.md) | Iterative BiRefNet matting plus LaMa background inpainting, connected-component cutouts, bounding boxes, rough z-order, and coarse text/vector/image hints | Output normalization, confidence and failure policy, durable assets, OCR/semantics, and native-versus-raster promotion; SVG/PSD exports remain raster and are not Wiggly render paths |
