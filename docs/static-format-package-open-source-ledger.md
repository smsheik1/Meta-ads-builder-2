...
| Semantic reference analysis | [Gemma 4 31B IT](https://build.nvidia.com/google/gemma-4-31b-it) | Provisional semantic leader, pipeline not selected; [schema-enforced holdout failed](./research-intake/static-reference-schema-holdout-2-smoke-2026-07-10.md) | Recovered both new ad formulas, produced strict JSON twice, and correctly excluded all OCR-visible Facebook chrome on Marpipe | One of two responses violated nested Draft-07; both failed semantic activation; strengthen List binding and platform policy before new holdouts |
