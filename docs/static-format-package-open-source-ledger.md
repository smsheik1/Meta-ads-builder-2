...
| Semantic reference analysis | [Gemma 4 31B IT](https://build.nvidia.com/google/gemma-4-31b-it) | Provisional benchmark leader; [full-contract smoke, SAM handoff, and two-challenger comparison passed](./research-intake/vision-challengers-codex-smoke-2026-07-10.md) | Bound all 9 OCR strings and both assets into the exact focal, supporting, and footer Reroll Groups; short prompts reproduced the correct SAM masks above 99.7% IoU; beat Nemotron Omni and Mistral Large 3 on the same contract | One-image result took 69.1 seconds and added one unnecessary Maker question; pass the unchanged saved-reference corpus before production selection |
...
| --- | --- | --- |
| [Nemotron 3 Nano Omni 30B-A3B Reasoning](https://build.nvidia.com/nvidia/nemotron-3-nano-omni-30b-a3b-reasoning) | Semantic runner-up or later self-hosting comparison; [one full-contract smoke complete](./research-intake/vision-challengers-codex-smoke-2026-07-10.md) | Correctly found the focal pair and supporting list, but omitted the handshake from authoritative core members, asked three unnecessary questions, took 86.0 seconds, and used 4,566 tokens; it did not beat Gemma |
| [Mistral Large 3 675B](https://build.nvidia.com/mistralai/mistral-large-3-675b-instruct-2512) | Fast semantic baseline; [one full-contract smoke complete](./research-intake/vision-challengers-codex-smoke-2026-07-10.md) | Completed in 9.8 seconds, but incorrectly grouped focal `Slack` with the supporting tools, omitted it from the core claim, and added three unnecessary questions; speed does not compensate for the wrong formula |
...
| 2026-07-10 | Keep Gemma 4 as provisional lead after testing the only two credible catalog challengers | On the same semantic contract, Nemotron omitted the handshake from core members and took 86.0 seconds; Mistral Large 3 incorrectly placed focal `Slack` in the support list despite completing in 9.8 seconds | Stop testing weaker models on the Codex reference and run Gemma unchanged on structurally different assistant-saved ads |
