...
export const discoveryCatalog: DiscoveryEntry[] = [
  ...
  {
    id: "bikini-bottom-dance-off-ghetto-love-story",
    status: "published",
    order: 11.6,
    brand: "Bikini Bottom",
    title: "Ghetto Love Story hits Bikini Bottom",
    curatorNote: "A fresh song excerpt gives SpongeBob, Patrick, Mr. Krabs, and Squilliam new solos, new taunts, and a finale built for replay.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/bikini-bottom-dance-off-v1/examples/ghetto-love-story/evidence/final.mp4",
      poster: "/format-repositories/bikini-bottom-dance-off-v1/examples/ghetto-love-story/evidence/poster.png",
  ...
  },
  {
    ...
    curatorNote: "Choose from 25 starter dances and 22 individually verified dancers. Nineteen are voice-ready; Agent P, Man Ray, and Batman Beyond remain honest no-match exceptions.",
    goal: "entertain",
    media: {
      kind: "video",
  ...
  {
    id: "shaz-puppet-runtime-talking-scene",
    status: "published",
    showInDiscovery: false,
    order: 11.72,
    brand: "Shaz Animated",
    ...
    media: {
      kind: "video",
      src: "/format-repositories/shaz-puppet-runtime-v1/goldens/talking-scene-lipsync-v1/final.mp4",
      poster:
...
export const discoveryShelfDefinitions = [
  ...
  },
  {
    ...
    description: "Voice-led pitches with a visual rhythm built around the message.",
    formats: ["visualizer"],
  },
  {
    id: "hybrid-news",
    title: "Hybrid News",
    description: "Brand announcements presented as a clear editorial story.",
    formats: ["hybrid-news"],
  },
  {
    id: "static-hooks",
    title: "Meme",
    description: "Familiar images carrying a sharp brand-specific punchline.",
    formats: ["meme"],
  },
  {
    id: "conversations",
    title: "iMessage Ad",
    description: "Brand stories told through a familiar text-message exchange.",
