...
export const discoveryCatalog: DiscoveryEntry[] = [
  ...
  {
    id: "shaz-puppet-runtime-five-authored",
    status: "published",
    showInDiscovery: false,
    order: 11.72,
    brand: "Shaz Animated",
    title: "Five recreated artist-authored actions",
    curatorNote:
      "Present, Think, Ah-ha, Point, and Confident replay through the recovered puppet renderer. Generated experimental poses are excluded from this showcase.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/shaz-puppet-runtime-v1/goldens/five-authored-showcase/final.mp4",
      poster:
