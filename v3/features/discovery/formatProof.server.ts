...
const formatConfigs: FormatProfileConfig[] = [
  ...
  },
  {
    ...
    promise: "Turn one supplied conversation audio track into a staged cat-and-bunny exchange with verified speakers, short progressive captions, three camera angles, and intentional emphasis motion.",
    lastUpdated: "August 2026",
    ...
    whatStays: [
      ...
      "Explicit per-beat speaker confirmation against the supplied audio",
    ...
    whatChanges: [
      ...
      "The timed dialogue, captions, and verified speakers",
    ...
    handoff: {
      ...
      deliverables: [
        ...
        "One checksum-bound speaker-assignment receipt",
        "One inspected contact sheet and quality report",
      ...
      instructions: [
        ...
        "Run init, directly review every extracted audio beat, record confirmedSpeaker and evidence, then run apply-speakers and validate",
