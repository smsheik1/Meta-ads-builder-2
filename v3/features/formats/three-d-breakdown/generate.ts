...
const getStoryboardStyleRules = (visualStyle: ThreeDBreakdownVisualStyle) => (
  visualStyle === "presenter-teardown-vsl"
    ? [
      ...
      "The six frames must feel like a real ecommerce product teardown with an unseen narrator, not a toy-character science world.",
      "Use a human demo subject, torso, hands, product-use surface, or over-shoulder demonstrator as the visual continuity spine in at least four frames, including frame 1 and frame 6.",
      ...
      "Frame 3: hands or demo subject demonstrate the product detail that sets up the mechanism.",
