    ...
    >
      ...
      <div className="absolute inset-x-[6cqw] top-[6cqw] flex items-center gap-[2.6cqw]">
        {brandMark ? (
          ...
          <div className="grid size-[9cqw] place-items-center rounded-full bg-white text-[4cqw] font-black text-slate-950">
      ...
      <div className="absolute inset-x-[7cqw] top-[32%]">
        <p
          className={`text-balance text-center text-[8.2cqw] font-black leading-[0.98] tracking-normal text-white drop-shadow-[0_0.7cqw_0_rgba(0,0,0,0.35)] ${flashHeadline}`}
      ...
      <div className="absolute inset-x-[9cqw] bottom-[10cqw] flex h-[14cqw] items-end justify-center gap-[1.2cqw]">
        {Array.from({ length: 18 }, (_, index) => {
          ...
          return (
            <span
              ...
              style={{ height: `${Math.min(92, height)}%` }}
            />
          );
        })}
      </div>
