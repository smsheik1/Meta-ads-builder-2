...
assert.deepEqual(styleBScene.layout.clipPlans?.map((clip) => clip.durationSeconds), [5, 5, 5, 5, 5, 5]);
assert.deepEqual(styleBScene.layout.clipPlans?.map((clip) => [clip.startMs, clip.endMs]), [[0, 3000], [3000, 6500], [6500, 10000], [10000, 13500], [13500, 17000], [17000, 20000]]);
assert.ok(styleBScene.layout.clipPlans?.[0]?.prompt.includes("clip 1 of 6"));
...
assert.ok(styleBScene.layout.clipPlans?.[3]?.prompt.includes("peak teardown"));
assert.ok(styleBScene.layout.clipPlans?.[4]?.prompt.includes("Proof payoff"));
assert.ok(styleBScene.layout.clipPlans?.[5]?.prompt.includes("product reframe"));
