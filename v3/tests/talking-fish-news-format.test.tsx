...
assert.ok(closedMouthHtml.includes('data-talking-fish-news-studio="true"'));
assert.ok(closedMouthHtml.includes('data-talking-fish-news-evidence-inset="true"'));
assert.equal(closedMouthHtml.includes('data-talking-fish-news-evidence-frame="true"'), false);
assert.ok(closedMouthHtml.includes('data-talking-fish-news-tv-frame="true"'));
assert.ok(closedMouthHtml.includes("tv-frame-overlay.png"));
assert.equal(closedMouthHtml.includes("tv-frame-chroma-source.png"), false);
...
assert.ok(closedMouthHtml.includes("translateY(5cqw)"));
assert.ok(closedMouthHtml.includes("mars-polygons-closeup.png"));
assert.ok(closedMouthHtml.includes("News evidence inset"));
