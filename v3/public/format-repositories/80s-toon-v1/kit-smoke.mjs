...
if (runtime.maximumAttempts !== 3 || runtime.expectedOutputs !== 1 || goldens.examples.length !== 8) {
  throw new Error("80s Toon runtime limits are invalid.");
}
...
console.log("80s Toon Format Kit files are complete.");
