...
const required = [
  ...
  "SKILL.md",
  "assets.json",
  "assets/source/shoreline-bather.jpg",
  "assets/source/shoreline-bather-reference.jpg",
...
if (
  ...
  goldens.examples.length !== 4
) {
  throw new Error("Sparkling Effect runtime limits are invalid.");
}
...
console.log("Sparkling Effect Format Kit files are complete.");
