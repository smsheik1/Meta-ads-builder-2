...
description: "Create a 36-second vertical four-character dance-off from a local song using the verified Character Dance Lab renderer."
---
...
5. Run `inspect` and watch the MP4. Confirm countdown beeps have no song underneath, opening/taunts/CTA use the assigned voices with no song underneath, the song plays only during dances, the group showcase lasts nine seconds, each challenger stays still while taunting the previous dancer, Squilliam moves during the CTA, and eyes, framing, captions, and CTA remain sound.
