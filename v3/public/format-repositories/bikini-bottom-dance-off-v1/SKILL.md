...
5. Run `inspect` and watch the MP4. Confirm countdown beeps have no song underneath, opening/taunts/CTA use the assigned voices with no song underneath, the song plays only during dances, every solo lasts at least five seconds, every finale motion covers the full nine seconds without a hold or clip loop, speakers gesture while waiting characters remain subtly alive, Squilliam moves during the CTA, captions stay in their reserved lane below the cast, the dimmed-character closing bridge joins cleanly to the matching opening countdown, and eyes, Reel-safe framing, captions, and CTA remain sound.
