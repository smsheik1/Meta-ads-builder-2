...
5. Run `inspect` and watch the MP4. Confirm countdown beeps have no song underneath, opening/taunts/CTA use the assigned voices with no song underneath, the song plays only during dances, every solo lasts at least five seconds, every finale motion covers the full nine seconds without a hold or clip loop, each challenger stays still while taunting the previous dancer, Squilliam moves during the CTA, the “Round Two?” bridge joins cleanly to the opening countdown, and eyes, framing, captions, and CTA remain sound.
