...
A 36-second 9:16 proof that turns one song excerpt into a four-way character dance battle. The Reel opens on a silent-song 3–2–1 countdown with beeps, then alternates spoken character roasts with dances: each incoming challenger taunts the dancer immediately before them and takes over. All four return for a nine-second group showcase before Squilliam delivers the comment prompt with a body-language Taunt motion.
