...
| 04 | Open wide | Review built rig-native candidate | `recipe-candidate` | The 31-frame native candidate is preserved at `poses/candidates/open-wide.json` and passes the unchanged full inspector. It remains narrower than the artist reference, and its relaxed setup/release are not exact neutral boundaries. Keep it unregistered until complete normal-speed review. Do not relabel Shrug or the rejected celebration. |
...
The engineering pass is complete enough for one review session: #03 maps to Confident; #05 and #07 review registered actions; #04, #06, #08, #09, #10, and #11 have exact review candidates; and #02 is blocked at its unchanged hand-proportion gate. Review each complete normal-speed artifact before any registration or safe-list change.
