...
- `shrug` is the first action certified against the new frame-by-frame visual standard.
- The other ten registered actions are renderable but are not yet certified to the Shrug standard.
