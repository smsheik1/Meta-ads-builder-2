...
const required = [
  ...
  "SKILL.md",
  "assets.json",
  "assets/source/car-headlights.jpg",
  "assets/source/car-headlights-reference.jpg",
...
if (
  ...
  throw new Error("Blue Phosphor runtime limits are invalid.");
}
...
console.log("Blue Phosphor Format Kit files are complete.");
