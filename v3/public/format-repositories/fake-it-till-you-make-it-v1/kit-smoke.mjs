...
const slug = "fake-it-till-you-make-it";
...
if (
  ...
  throw new Error("Eight-scene runtime limits are invalid.");
}
...
console.log("Fake It Till You Make It Format Kit files are complete.");
