...
This Wiggly Repo turns a user-downloaded Mixamo Collada animation into a deterministic, full-body character clip. It keeps every source frame, scales root travel to the target character's leg length, grounds feet from source contact data, maps fingers when the character supports them, and resets protected face and eye bones every frame.
...
- Contact feet do not sink into the floor; jump frames may leave it.
