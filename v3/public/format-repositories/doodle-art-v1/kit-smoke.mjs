...
const required = [
  ...
  "SKILL.md",
  "assets.json",
  "assets/source/neon-fashion-doodle.jpg",
  "assets/source/neon-fashion-reference.jpg",
...
if (
  ...
  goldens.examples.length !== 5
) {
  throw new Error("Doodle Art runtime limits are invalid.");
}
...
console.log("Doodle Art Format Kit files are complete.");
