...
const kitName = "wiggly-squilliam-news-format-kit";
...
function include(source) {
  ...
  if (parts.some((part) => excludedNames.has(part) || part.endsWith(".pyc"))) return false;
  return true;
}
...
const temporary = await mkdtemp(path.join(tmpdir(), "wiggly-squilliam-news-"));
