...
const slug = "rim-portrait-filter";
...
const required = [
  ...
  "assets/source/skai-example-06.jpg",
  "format.json",
  "goldens.json",
  "inputs.json",
  "pipeline.json",
...
if (
  ...
  throw new Error("Rim Portrait Filter runtime limits are invalid.");
}
...
console.log("Rim Portrait Filter Format Kit files are complete.");
