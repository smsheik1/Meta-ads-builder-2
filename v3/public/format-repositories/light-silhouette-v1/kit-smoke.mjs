...
const required = [
  ...
  "SKILL.md",
  "assets.json",
  "assets/source/coastal-cliff.jpg",
  "assets/source/coastal-cliff-reference.jpg",
...
if (
  ...
  throw new Error("Light Silhouette runtime limits are invalid.");
}
...
console.log("Light Silhouette Format Kit files are complete.");
