...
const slug = "dark-aesthetic-filter";
...
if (runtime.maximumAttempts !== 3 || runtime.expectedOutputs !== 1 || goldens.examples.length !== 11) {
  throw new Error("Dark Aesthetic Filter runtime limits are invalid.");
}
...
console.log("Dark Aesthetic Filter Format Kit files are complete.");
