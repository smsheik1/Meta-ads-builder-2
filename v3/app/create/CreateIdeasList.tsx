...
export function CreateIdeasList({
  ...
  return (
    <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_24px_70px_rgba(15,23,42,0.10)]">
      <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">All ideas</p>
        ...
        {scenes.map((scene, index) => (
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <span className="rounded-full bg-white px-3 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">
