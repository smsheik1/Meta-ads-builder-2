...
const packagePath = path.join(process.cwd(), "public", "format-repositories", "were-sorry-v1");
...
const files = [
  ...
  ["prompts/research.md", "Evidence and safety rules"],
  ["prompts/apology.md", "Apology writing rules"],
  ["quality.json", "Acceptance checks"],
] as const;

export default function WereSorryFormatPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f8fa] text-slate-950">
      ...
      <div className="mx-auto max-w-6xl space-y-7 px-5 py-7">
          ...
          <div className="flex flex-wrap items-start justify-between gap-5">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm font-semibold text-violet-700">
                One website in. Eight 1080 x 1350 PNGs out.
              </p>
            </div>
            <Button asChild data-testid="download-were-sorry-kit">
              <a href="/format-repositories/were-sorry-v1/downloads/wiggly-were-sorry-format-kit.zip" download>
        ...
        <section data-testid="were-sorry-golden">
          ...
          <div className="mt-4 grid gap-5 lg:grid-cols-[minmax(0,420px)_1fr]">
            {goldens.examples.map((example) => (
              <article key={example.id} className="overflow-hidden rounded-lg border border-slate-300 bg-white shadow-sm">
                <img
                  ...
                  src={`/format-repositories/were-sorry-v1/${example.imagePath}`}
            ...
            <article className="rounded-lg border border-slate-300 bg-white p-5 shadow-sm">
              <h2 className="font-bold">Funny because it is specific</h2>
              <ul className="mt-3 space-y-3 text-sm text-slate-700">
                <li>The agent asks for one website and handles the rest.</li>
                <li>Eight angles create a useful pack without more questions.</li>
                <li>The serious wrapper makes each product truth land harder.</li>
                <li>Trust-sensitive categories stop before the joke is written.</li>
                <li>Every PNG uses Wiggly&apos;s shared renderer.</li>
        ...
        <section data-testid="were-sorry-pipeline">
        ...
        <section className="grid gap-5 lg:grid-cols-2">
          <article className="rounded-lg border border-slate-300 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 overflow-auto rounded-md bg-slate-950 p-4 font-mono text-xs leading-6 text-slate-100">
              npm run format:were-sorry -- init --run=&lt;id&gt; --url=&lt;url&gt;<br />
              npm run format:were-sorry -- prompt --run=&lt;id&gt;<br />
              npm run format:were-sorry -- validate --run=&lt;id&gt;<br />
              npm run format:were-sorry -- render --run=&lt;id&gt;<br />
          ...
          <article className="rounded-lg border border-slate-300 bg-white p-5 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700">
              ...
              <li>Unsupported claims cannot become confessions.</li>
              <li>Repeated or generic jokes fail validation.</li>
              <li>Trust-sensitive harm blocks the format.</li>
        ...
        <section>
          ...
          <p className="mt-1 text-sm text-slate-600">The package carries its recipe, tests, and renderer.</p>
