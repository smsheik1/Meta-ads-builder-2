...
const formatRelative = path.join("public", "format-repositories", "visualizer-v1");
const formatRoot = path.join(v3Root, formatRelative);
const stagingParent = path.join(v3Root, "tmp", "visualizer-format-kit");
const kitName = "wiggly-visualizer-format-kit";
...
for (const relativePath of [
  ...
  "tests/visualizer-agent-runner.test.ts",
]) {
...
await writeFile(
  ...
  [
    ...
    "Open `v3/public/format-repositories/visualizer-v1/README.md` for the human quick start.",
