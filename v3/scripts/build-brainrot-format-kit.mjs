...
const formatRelative = path.join("public", "format-repositories", "brainrot-v1");
const formatRoot = path.join(v3Root, formatRelative);
const stagingParent = path.join(v3Root, "tmp", "brainrot-format-kit");
const kitName = "wiggly-brainrot-format-kit";
...
for (const relativePath of [
  ...
  "tests/brainrot-agent-runner.test.ts",
]) {
...
await writeFile(
  ...
  [
    "# Wiggly Brainrot Format Kit",
    "",
    "Open `v3/SKILL.md` if you are an agent.",
    "Open `v3/public/format-repositories/brainrot-v1/README.md` for the human quick start.",
