...
const formatRelative = path.join("public", "format-repositories", "were-sorry-v1");
const formatRoot = path.join(v3Root, formatRelative);
const stagingParent = path.join(v3Root, "tmp", "were-sorry-format-kit");
const kitName = "wiggly-were-sorry-format-kit";
...
for (const relativePath of [
  ...
  "features/scene",
  "remotion-entry",
  "scripts/were-sorry-format.ts",
  "tests/were-sorry-agent-runner.test.ts",
]) {
...
await writeFile(
  ...
  [
    "# Wiggly We're Sorry Format Kit",
    "",
    "Open `v3/SKILL.md` if you are an agent.",
    "Open `v3/public/format-repositories/were-sorry-v1/README.md` for the human quick start.",
