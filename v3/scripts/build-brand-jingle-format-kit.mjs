...
const formatRelative = path.join("public", "format-repositories", "brand-jingle-v1");
const formatRoot = path.join(v3Root, formatRelative);
const stagingParent = path.join(v3Root, "tmp", "brand-jingle-format-kit");
const kitName = "wiggly-brand-jingle-format-kit";
...
for (const relativePath of [
  ...
  "tests/brand-jingle-agent-runner.test.ts",
]) {
