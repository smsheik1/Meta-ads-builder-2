...
const formatRelative = path.join("public", "format-repositories", "meme-v1");
const formatRoot = path.join(v3Root, formatRelative);
const stagingParent = path.join(v3Root, "tmp", "meme-format-kit");
const kitName = "wiggly-meme-format-kit";
...
for (const relativePath of [
  ...
  "features/scene",
  "remotion-entry",
  "scripts/meme-format.ts",
  "tests/meme-agent-runner.test.ts",
]) {
  await copyFromV3(relativePath);
}
await copyFromV3("public/fonts");
await copyFromV3("public/memes");
