...
const formatRelative = path.join("public", "format-repositories", "reviews-v1");
const formatRoot = path.join(v3Root, formatRelative);
const stagingParent = path.join(v3Root, "tmp", "reviews-format-kit");
const kitName = "wiggly-reviews-format-kit";
...
for (const relativePath of [
  ...
  "tests/reviews-agent-runner.test.ts",
]) {
...
await writeFile(
  ...
  [
    ...
    "Open `v3/public/format-repositories/reviews-v1/README.md` for the human quick start.",
